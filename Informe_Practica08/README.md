...
•	Comprender los fundamentos de una API REST y su implementación utilizando Node.js + Express.
•	Desarrollar un backend básico que exponga endpoints REST para operaciones CRUD simples.
•	Manipular datos en formato JSON mediante solicitudes HTTP estándar.
•	Probar y validar el funcionamiento de la API utilizando herramientas de prueba de servicios REST.
•	Analizar el flujo completo de una solicitud REST: cliente → servidor → procesamiento → respuesta.
